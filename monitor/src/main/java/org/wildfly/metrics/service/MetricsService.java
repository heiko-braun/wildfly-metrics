...
package org.wildfly.metrics.service;
...
import org.wildfly.metrics.extension.MonitorLogger;
...
public class MetricsService implements Service<MetricsService> {
    ...
    public MetricsService(ModelNode config) {
    ...
    public static ServiceController<MetricsService> createService(final ServiceTarget target,
                                                                     final ServiceVerificationHandler verificationHandler,
                                                                     ModelNode config) {

        MetricsService service = new MetricsService(config);
